...
import { FpsChart } from './components';
          ...
          <section className="control-section">
            ...
            <label className="toggle-option">
              ...
              <div className="toggle-info">
                ...
                <span className="toggle-desc">Simplified rendering (faster)</span>
              </div>
            </label>
          </section>
          ...
          <section className="control-section">
            ...
            <label className="toggle-option">
              ...
              <div className="toggle-info">
                ...
                <span className="toggle-desc">Skip rendering off-screen</span>
              </div>
            </label>
            ...
            <label className="toggle-option">
              ...
              <div className="toggle-info">
                ...
                <span className="toggle-desc">Isolate layout/paint</span>
              </div>
            </label>
          ...
          <section className="control-section">
            ...
            {(options.renderMode === 'mixed' || options.renderMode === 'markdown') && (
              <label className="toggle-option">
                ...
                <div className="toggle-info">
                  ...
                  <span className="toggle-desc">Skip syntax highlighting</span>
                </div>
              </label>
            )}
            ...
            <label className="toggle-option">
              ...
              <div className="toggle-info">
                ...
                <span className="toggle-desc">Word-by-word animation</span>
              </div>
            </label>
          ...
          <div className="metrics-bar">
            ...
            <div className="metric">
              <span
                ...
                style={{
                  color: fps.current >= 50 ? '#22c55e' : fps.current >= 30 ? '#eab308' : '#ef4444',
                }}
              >
                {fps.current}
              </span>
